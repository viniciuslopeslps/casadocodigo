...
<head>
    ...
    <title>${ product.title }-Casadocódigo</title>
    ...
    <link href="${contextPath}resources/cssresponsive-style.css" rel="stylesheet" type="text/css" media="all"/>
        ...
        <form:form servletRelativeAction="/carrinho/add" method="post" cssClass="container">
            <ul id="variants" class="clearfix">
                ...
                <c:forEach items="${product.prices}" var="price">
                    <li class="buy-option">
                        <input type="radio" name="priceType" class="variant-radio" id="priceType"
                               value="${ price.type}" checked="checked"/>
            ...
            <button type="submit" class="submit-image icon-basket-alt" alt="Compre Agora"
                    title="Compre Agora ${product.title } !"></button>
        </form:form>
...
<footer id="layout-footer">
    <div class="clearfix container">
        ...
        <div id="social-footer">
            ...
            <ul class="footer-text-links">
                <li><a href="http://livros.casadocodigo.com.br" rel="nofollow">
                    Meus E-books</a></li>
                ...
                <li><a href="https://www.caelum.com.br"> Caelum - Ensino e
                    Inovação</a></li>
                <li><a href="http://www.codecrushing.com/" rel="nofollow">
                    Code Crushing</a></li>
                <li><a
